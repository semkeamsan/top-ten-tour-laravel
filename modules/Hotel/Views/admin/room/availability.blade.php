        ...
        formModal = new Vue({
                ...
                show:function (form) {
                    ...
                    if(typeof form !='undefined'){
                        ...
                        if(form.start_date){
                            ...
                            drp.setStartDate(moment(form.start_date).format(topTenTour.date_format));
                            drp.setEndDate(moment(form.end_date).format(topTenTour.date_format));
            ...
            created:function () {
                ...
                this.$nextTick(function () {
                    $('.has-daterangepicker').daterangepicker({ "locale": {"format": topTenTour.date_format}})
