...
class Hotel extends Bookable
{
    ...
    public function addToCart(Request $request)
    {
        ...
        if ($this->isDepositEnable()) {
            ...
            $booking->deposit_type = $commission->type;
            $booking->deposit = $commission_amount;
            /*
            $booking->deposit_type = $this->getDepositType();
            switch ($this->getDepositType()) {
                case "percent":
                    $booking->deposit = $tmp_price_total * $this->getDepositAmount($this->create_user) / 100;
                    break;
                default:
        ...
        // dd($booking, $commission->type, $commission->amount);
    ...
    public function getDepositAmount($vendor_id = null)
    {
        ...
        if ($vendor_id) {
            ...
            if ($user) {
                $deposit_amount = $user->vendor_commission_amount;
            }
        }
