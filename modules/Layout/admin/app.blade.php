...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'Top Ten Tour'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('Top Ten Tour by')}} <a href="{{__('http://eocambo.com')}}" target="_blank">{{__('eOcambo Technology')}}</a>
                    </div>
