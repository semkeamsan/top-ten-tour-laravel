...
@section('script.body')
    ...
    <script>
        ...
        $('.dungdt-form-payout-btn').on('click',function () {
            var ids = $('.check-item:checked').map(function(){
                return $(this).val();
            }).get();
            if(!ids || !ids.length){
                topTenTourApp.showError("{{__('Please select at lease one item')}}")
                return;
            }
        ...
        $('.dungdt-form-payout-delete').on('click',function () {
        ...
        $('.dungdt-form-payout-save').on('click',function () {
            var form = $(this).closest('.modal');
            var status = form.find('[name=action]').val();
            if(!status){
                topTenTourApp.showError("{{__("Status is empty")}}");
                return;
            }
            var ids = $('.check-item:checked').map(function(){
                return $(this).val();
