jQuery(function ($) {
    "use strict"
    if (topTenTour_gateways_twocheckout.twocheckout_publishable_key === '') {
    ...
    var tokenRequest = function () {
        ...
        var args = {
            sellerId: topTenTour_gateways_twocheckout.twocheckout_account_number,
            publishableKey: topTenTour_gateways_twocheckout.twocheckout_publishable_key,
            ccNo: card_number,
            cvv: card_cvc,
