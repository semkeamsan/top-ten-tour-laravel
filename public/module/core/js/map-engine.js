(function ($) {
    ...
    window.BravoMapEngine = function (id,configs) {
        switch (topTenTour.map_provider) {
            case "osm":
    ...
    OsmMapEngine.prototype.initScripts = function (func) {
        ...
        script.src= topTenTour.url_root+'/libs/leaflet1.4.0/leaflet.js';
        head.appendChild(script);

        var link = document.createElement('link');
        link.rel = 'stylesheet';
        link.href = topTenTour.url_root+'/libs/leaflet1.4.0/leaflet.css';
    ...
    GmapEngine.prototype.initScripts = function (func) {
        ...
        var script= document.createElement('script');
        script.type= 'text/javascript';
        script.src= 'https://maps.googleapis.com/maps/api/js?key='+topTenTour.map_gmap_key+'&libraries=places';
        head.appendChild(script);

		var script2 = document.createElement('script');
		script2.type= 'text/javascript';
		script2.src= topTenTour.url+'/libs/infobox.js';
