jQuery(document).ready(function ($) {
    'use strict';
    var stripePublishKey = topTenTour_gateways_stripe.stripe_publishable_key;
    if (topTenTour_gateways_stripe.stripe_enable_sandbox === "1") {
        stripePublishKey = topTenTour_gateways_stripe.stripe_test_publishable_key;
    }
    if (stripePublishKey === '') {
        return false;
    }
