    ...
    window.uploaderModal = new Vue({
        ...
        methods:{
                ...
                topTenTourApp.showConfirm({
                    ...
                    callback: function(result){
                        if(result){
                            me.isLoading = true;
                            $.ajax({
                                url:topTenTour.url+'/admin/module/media/removeFiles',
                                type:'POST',
                                data:{
            ...
            reloadLists(){
                ...
                me.isLoading = true;
                $.ajax({
                    url:topTenTour.url+'/admin/module/media/getLists',
                    type:'POST',
                    data:{
            ...
            upload(files){
                ...
                for(var i = 0; i < files.length ; i++){
                    ...
                    me.isLoading = true;
                    $.ajax({
                        url:topTenTour.url+'/admin/module/media/store',
                        data:d,
                        dataType:'json',
                        type:'post',
                        contentType: false,
