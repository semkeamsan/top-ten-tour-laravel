/*import TopTenTourAdaterPlugin from "../../../../resources/admin/js/ckeditor/uploadAdapter";*/
            ...
            file_picker_callback: function (callback, value, meta) {
                ...
                if (meta.filetype === 'file') {
                    uploaderModal.show({
                        ...
                        onSelect:function (files) {
                            if(files.length)
                                callback(topTenTour.url+'/media/preview/'+files[0].id);
                        },
                    });
                }
...
var vendorPayout = {
    saveAccounts:function (btn) {
        ...
        $.ajax({
            url:topTenTour.url+'/vendor/storePayoutAccounts',
            method:"post",
            ...
            success:function (json) {
                ...
                if(json.message){
                    topTenTourApp.showSuccess(json.message);
                }
                if(json.status){
    ...
    sendRequest:function (btn) {
        ...
        $.ajax({
            url:topTenTour.url+'/vendor/createPayoutRequest',
            method:"post",
